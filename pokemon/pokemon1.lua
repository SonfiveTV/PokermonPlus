...
local meltan = { 
  ...
  loc_vars = function(self, info_queue, card)
    type_tooltip(self, info_queue, card) 
    info_queue[#info_queue+1] = {set = 'Other', key = 'designed_by', vars = {"Sonfive"}}
		return {vars = {card.ability.extra.count, card.ability.extra.evo_rqmt}} -- Here you can reference values in the Joker description
  end,
  ...
  atlas = "pokedex_7", -- This is the spritesheet that the pokemons sprite is located on
