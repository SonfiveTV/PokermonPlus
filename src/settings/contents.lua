  ...
  pages = {
    {
      ...
      tiles = {
        ...
        { list = { "j_sonfive_helioptile", "j_sonfive_heliolisk" }, label = function() return localize { type = "name_text", set = "Joker", key = "j_sonfive_helioptile" } end, config_key = "helioptile" },
    ...
    },
    {
      ...
      tiles = {
        ...
        { list = { "j_sonfive_nacli", "j_sonfive_naclstack", "j_sonfive_garganacl" }, label = function() return localize { type = "name_text", set = "Joker", key = "j_sonfive_nacli" } end, config_key = "nacli" },
    ...
    {
      title = function() return localize("sonfive_config_page3") end,
      tiles = {
